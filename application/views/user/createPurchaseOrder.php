                            ...
                            <?php echo form_open_multipart('user/tambahPO','class="form-horizontal"')?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" placeholder="/gr" name="hargaBahan" class="form-control" value="<?php echo set_value('hargaBahan'); ?>" required="">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="jumlahDatangBerlian" placeholder="%" value="<?php echo set_value('jumlahDatangBerlian'); ?>"  class="form-control" required="">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Upah Pasang Berlian</label>
                                                <input type="text" placeholder="/gr" name="upahPasangBerlian" class="form-control" value="<?php echo set_value('upahPasangBerlian'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
